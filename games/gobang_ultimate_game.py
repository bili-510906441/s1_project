...
class Gobang:
    ...
    def create_widgets(self):
        ...
        self.undo_btn = tk.Button(button_frame, text="悔棋", command=self.undo)
        self.undo_btn.pack(side=tk.LEFT, padx=10)
        
        tk.Button(button_frame, text="新游戏", command=self.reset_game).pack(side=tk.LEFT, padx=10)
    ...
    def draw_piece(self, row, col, player):
        ...
        self.canvas.create_oval(x-10, y-10, x+10, y+10, fill=color, tags="piece")
